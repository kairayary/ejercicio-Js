let Data =
{
 ...
 for(i=0; i<Data.results[0].members.length; i++){ 
  ...
  var DatoHouse= Data.results[0].members[i].first_name + " " + Data.results[0].members[i].middle_name + " " + Data.results[0].members[i].last_name;
 ...
 tr += "<td>" + (i+1) + "</td>";
  ...
  tr += "</tr>"; document.getElementById("house-data").innerHTML += tr; 
}
